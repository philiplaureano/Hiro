...
namespace Hiro.Compilers
{
    ...
    internal class SingletonEmitter
    {
        ...
        public void EmitService(MethodDefinition newMethod, IDependency dependency, IImplementation implementation)
        {
            ...
            DefineNestedType(module, containerType, dependency, implementation, objectType, singletonType, instanceField);

            DefineGetInstance(singletonType, worker, instanceField);
        ...
        private static void DefineGetInstance(TypeDefinition singletonType, CilWorker worker, FieldDefinition instanceField)
        {
        ...
        private static void DefineNestedType(ModuleDefinition module, TypeDefinition containerType, IDependency dependency, IImplementation implementation, TypeReference objectType, TypeDefinition singletonType, FieldDefinition instanceField)
        {
            ...
            DefineNestedStaticConstructorBody(module, dependency, implementation, instanceField, cctor, containerLocal, containerConstructor);
        }
            ...
            MethodDefinition containerConstructor)
        {
            ...
            implementation.Emit(dependency, cctor);
