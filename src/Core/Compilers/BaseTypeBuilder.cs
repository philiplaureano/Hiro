...
namespace Hiro.Compilers
{
    ...
    public abstract class BaseTypeBuilder
    {
        ...
        public TypeDefinition CreateType(string typeName, string namespaceName, TypeReference baseType,
            AssemblyDefinition assembly, params TypeReference[] interfaces)
        {
