...
namespace Hiro.Interfaces
{
    ...
    /// </summary>
    public interface IServiceMapBuilder<TMethodBuilder>
    {
        /// <summary>
        ...
        IDictionary<IDependency, IImplementation<TMethodBuilder>> GetAvailableServices(IDependencyContainer<TMethodBuilder> dependencyContainer);
    }
}
